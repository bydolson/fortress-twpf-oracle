...
### VS Code
If you want to compile your project with VS Code task runner you need to overwrite the config `typescript.tadapter` to path of the installed `ttypescript`:
```
"typescript.tadapter": "/usr/local/lib/node_modules/ttypescript/lib",
or
"typescript.tadapter": "node_modules/ttypescript/lib",
```
